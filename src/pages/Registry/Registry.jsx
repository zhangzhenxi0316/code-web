          ...
          <Particles  className="body"
            ...
            <LoginWrapper>
               ...
               {role===1 && <Item>
                    ...
                    <div className="inputWrapper">
                      <i className="iconfont">&#xe63f;</i>
                    <input className="input" type="number" onChange={this.handleStuChange} value={this.state.stuId} placeholder="请输入用户名"/>
                    </div>
                </Item>}
                <Item>
                    ...
                    <div className="inputWrapper">
                    <i className="iconfont">&#xe7b8;</i>
                    <input className="input" type="password" onChange={this.handlePasswordChange} value={this.state.password} placeholder="请输入密码"/>
                    </div>
                </Item>
                <div className="selectWrapper">
                <Select defaultValue="0" className="select"  onChange={this.handleRoleChange} >
                  <Option className="option" value="0">教师</Option>
                  <Option className="option" value="1">学生</Option>
